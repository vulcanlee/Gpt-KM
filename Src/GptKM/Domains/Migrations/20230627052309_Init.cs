        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourcePath = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpertDirectory_Name",
                table: "ExpertDirectory",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_ExpertDirectory_SourcePath",
                table: "ExpertDirectory",
                column: "SourcePath");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpertFileChunk_FullName",
                table: "ExpertFileChunk",
                column: "FullName");

            migrationBuilder.CreateIndex(
                name: "IX_ExpertFileChunk_FullName_ConvertIndex",
                table: "ExpertFileChunk",
                columns: new[] { "FullName", "ConvertIndex" });
