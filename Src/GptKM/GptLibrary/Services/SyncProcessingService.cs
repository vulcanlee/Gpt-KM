...
public class SyncProcessingService
{
    ...
    private readonly ILogger<SyncProcessingService> logger;
    ...
    public SyncProcessingService(SyncDirectoryService syncDirectoryService,
        ...
        ILogger<SyncProcessingService> logger)
    {
    ...
    public async Task BeginSyncDirectoryAsync(ExpertDirectory expertDirectory)
    {
        ...
        try
        {
            ...
            {
                logger.LogError(ex, $"將檔案內容轉換成為文字檔案 "+ex.StackTrace);
            }
            #endregion
        ...
        {
            logger.LogError(ex, $"掃描目錄 BeginSyncDirectoryAsync");
        }
    }
}
