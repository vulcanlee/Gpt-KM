...
namespace Backend.ViewModels
{
    ...
    public class ExpertDirectoryViewModel
    {
        #region Constructor
        public ExpertDirectoryViewModel(IExpertDirectoryService CurrentService,
           ...
           TranscationResultHelper transcationResultHelper)
        {
            ...
            mapper = Mapper;
            TranscationResultHelper = transcationResultHelper;
            ExpertDirectorySort.Initialization(SortConditions);
        ...
        /// 現在正在新增或修改的紀錄  
        /// </summary>
        public ExpertDirectoryAdapterModel CurrentRecord { get; set; } = new ExpertDirectoryAdapterModel();
        /// <summary>
        /// 現在正在刪除的紀錄  
        /// </summary>
        public ExpertDirectoryAdapterModel CurrentNeedDeleteRecord { get; set; } = new ExpertDirectoryAdapterModel();
        /// <summary>
        /// 保存與資料編輯程式相關的中繼資料
        /// </summary>
        ...
        /// </summary>
        private readonly IExpertDirectoryService CurrentService;
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            ...
            {
                CurrentRecord = new ExpertDirectoryAdapterModel();
        ...
        public async Task OnCommandClicked(CommandClickEventArgs<ExpertDirectoryAdapterModel> args)
        {
            ExpertDirectoryAdapterModel item = args.RowData as ExpertDirectoryAdapterModel;
