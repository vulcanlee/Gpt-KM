...
namespace Backend.Services
{
    public class RootFileUploadService : IRootFileUploadService
    {
        ...
        public async Task<string> CheckWetherCanRootFileUpload(MyUserAdapterModel myUserAdapterModel, string newPassword)
        {
            string result = "";
        ...
        public async Task RootFileUpload(MyUserAdapterModel myUserAdapterModel, string newPassword,
            string ip)
        {
            CleanTrackingHelper.Clean<AccountPolicy>(context);
            CleanTrackingHelper.Clean<MyUserPasswordHistory>(context);
            ...
            {
                myUser.ForceRootFileUploadDatetime = DateTime.Now
                    .AddDays(AccountPolicy.PasswordAge);
            }
            myUser.ForceRootFileUpload = false;
            #endregion
            ...
            if (AccountPolicy.EnablePasswordHistory == true)
            {
                MyUserPasswordHistory myUserPasswordHistory = new MyUserPasswordHistory()
                {
                    ...
                    RootFileUploadDatetime = DateTime.Now,
                };
                ...
                while (true)
                {
                    ...
                    var myUserPasswordHistories = await context.MyUserPasswordHistory
                        ...
                        .OrderBy(x => x.RootFileUploadDatetime)
                        .ToListAsync();
