namespace Backend.Adapters
{
    ...
    public partial class ExpertFileChunkAdapter : DataAdaptor<IExpertFileChunkService>
    {
        [Parameter]
        ...
        public override async Task<object> ReadAsync(DataManagerRequest dataManagerRequest, string key = null)
        {
            ...
            try
            {
                DataRequestResult<ExpertFileChunkAdapterModel> adaptorModelObjects = await Service.GetAsync(dataRequest);
            ...
            {
                return new DataResult() { Result = new List<ExpertFileChunkAdapterModel>(), Count = 0 };
            }
            #endregion
        }
    }
