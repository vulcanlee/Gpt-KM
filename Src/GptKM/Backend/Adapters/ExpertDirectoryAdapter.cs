...
public partial class ExpertDirectoryAdapter : DataAdaptor<IExpertDirectoryService>
{
    [Parameter]
    ...
    public override async Task<object> ReadAsync(DataManagerRequest dataManagerRequest, string key = null)
    {
        ...
        try
        {
            DataRequestResult<ExpertDirectoryAdapterModel> adaptorModelObjects = await Service.GetAsync(dataRequest);
        ...
        {
            return new DataResult() { Result = new List<ExpertDirectoryAdapterModel>(), Count = 0 };
        }
        #endregion
    }
}
